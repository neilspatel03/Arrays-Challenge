...
class ViewController: UIViewController, UITableViewDataSource,UITableViewDelegate {
    ...
    ***************************************************/
    var myFavoriteMovies = ["Dark Knight", "Fast and Furious", "Transporter", "Star Trek"]
    ...
    ***************************************************/
    ...
    @IBAction func onStretch1Pressed(_ sender: UIButton) {
        ...
        ***************************************************/
        myFavoriteMovies[1] = "Joker"
        myFavoriteMovies.append("The Longest Yard")
        myFavoriteMovies.insert("Halloween", at: 3)
